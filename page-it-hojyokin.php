...
<?php get_header(); ?>
  ...
  <div id="it">
    <div class="inner">
      <section class="hero">
        <picture>
          <source media="(max-width:600px)" srcset="<?php echo get_template_directory_uri(); ?>/images/it/hero_sp.jpg">
          <img src="<?php echo get_template_directory_uri(); ?>/images/it/hero_pc.jpg" alt="平成２９年度IT導入補助金　補助金受給額50万円 IT導入補助金×オウンドメディア">
        </picture>
      </section>
      <section class="s1">
      ...
      <section class="s2">
        ...
        <p class="s2_p_1">
          中小企業・小規模事業者のみなさまが、<br>
          業務効率化・売上アップなど生産性向上を目的とした<br>
          <strong>ITツール（ソフトウエア、サービスなど）の<br class="sp">導入経費の一部を補助する制度</strong>です。<br>
          IT導入の対象として、<br class="sp">Webサイトの制作やSEO支援も含まれております。
        </p>
      </section>
      <section class="s3">
        <h2 class="it_h2_1">IT導入補助金の概要</h2>
        <table>
          <tr>
            <th>予算総額</th>
            <td>500億円<span>※なくなり次第終了となります。</span></td>
          </tr>
          <tr>
            <th>補助金額</th>
